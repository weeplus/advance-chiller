...
<body>
				...
				<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
					<nav class="navbar">
						<ul class="navbar-nav">
							...
							<li><a href="about.html"><?=_About_Us?></a></li>
							<li><a href="#" onclick="openSlideMenu()"><?=_Products?></a></li>
	...
	</div>	<a href="index.php" class="btn-close" onclick="closeSlideMenu()">&times;</a>
		<a href="#"><?=_Air_Cooled?></a>
